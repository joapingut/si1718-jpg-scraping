...
public class ArticlesScrapper {
	...
	public static final String URL_BASE = "https://investigacion.us.es";
	public static final String URL_EXAMPLE = "https://investigacion.us.es/sisius/sis_showpub.php?idpers=4051";
	public static final String URL_DEPARTAMENTS = "https://investigacion.us.es/sisius/sis_dep.php";
	public static final String H5_TEST = "PUBLICACIONES EN REVISTAS";
